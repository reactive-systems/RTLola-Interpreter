...
use crate::value_factory::struct_factory::{
    expand_named_struct, expand_unit_struct, expand_unnamed_struct,
};
...
pub(crate) fn expand(input: TokenStream) -> TokenStream {
    ...
    let res = match &input.data {
        ...
        Data::Union(_) => abort!(
            input,
            "ValueFactory can only be derived for Structs and Enums!"
        ),
    };
